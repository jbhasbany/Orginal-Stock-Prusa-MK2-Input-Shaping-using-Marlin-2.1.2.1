...
#define STRING_CONFIG_H_AUTHOR "(Jon, Original Stock MK2 Config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Jon MK2 - Marlin 2.1.2.1"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 161.3 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {24, 10, 3 }
...
#define INVERT_Y_DIR false // Necessary for MK2, default true
...
//#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT 7  // Y point for Z homing
#endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_Z_RAISE_MIN   0.4 // (mm) Always raise Z by at least this distance
